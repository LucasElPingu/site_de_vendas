...
function parsePrice(input: string): number {
  const n = parseFloat(
    input.replace(/[^0-9.,]/g, "").replace(".", "").replace(",", ".")
  );
...
async function fetchGviz(
  ...
  const json: GvizResponse = JSON.parse(
    txt.replace(/^.*?\(/, "").replace(/\);?$/, "")
  );
  ...
  const sample: Product[] = [
    {
      ...
      image:
        "https://images.unsplash.com/photo-1552374196-c4e7ffc6e126?q=80&w=1200&auto=format&fit=crop",
      linkWhatsApp:
        "https://wa.me/5500000000000?text=Quero%20a%20Oversized%20Onyx",
      category: "Unisex",
      available: true,
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1503341455253-b2e723bb3dbb?q=80&w=1200&auto=format&fit=crop",
      linkWhatsApp:
        "https://wa.me/5500000000000?text=Quero%20a%20Oversized%20Storm",
      category: "Unisex",
      available: true,
    },
    {
      ...
      linkWhatsApp:
        "https://wa.me/5500000000000?text=Quero%20a%20Oversized%20Void",
      category: "Masculino",
      available: true,
    },
    {
      ...
      linkWhatsApp:
        "https://wa.me/5500000000000?text=Quero%20a%20Oversized%20Quartz",
      category: "Feminino",
      available: true,
    },
  ];
