    ...
    <footer className={styles.footerRoot}>
      <div className="container mx-auto px-4 py-10">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          <div>
            <h3
              className={`$"text-xl md:text-2xl font-semibold font-graffiti tracking-tight" ${styles.textLogo}`}
            >
              Can Say
            </h3>
            <p
              className={`$"text-white/70 mt-2 max-w-xl text-sm md:text-base" ${styles.fontFormat}`}
            >
              ROUPA É ARTE, NÃO PADRÃO
            </p>
          </div>
          <Image
        ...
        <div className="mt-1 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <p className="text-white/60 text-xs">
            ...
            Can Say — Todos os direitos reservados.
          </p>
        </div>
      </div>
    </footer>
